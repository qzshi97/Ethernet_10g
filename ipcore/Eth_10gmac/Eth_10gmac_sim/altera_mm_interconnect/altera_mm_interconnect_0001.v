...
`timescale 1 ps / 1 ps
module altera_mm_interconnect_0001 (
	...
	altera_merlin_router_0001 router (
	...
	altera_merlin_router_0002 router_001 (
	...
	altera_merlin_router_0002 router_002 (
	...
	altera_merlin_demultiplexer_0001 cmd_demux (
		.clk                (csr_clk_module_clk_clk),                                                           //        clk.clk
		.reset              (merlin_master_translator_reset_reset_bridge_in_reset_reset),                       //  clk_reset.reset
	...
	altera_merlin_multiplexer_0001 cmd_mux (
		.clk                 (tx_clk_module_clk_clk),                       //       clk.clk
		.reset               (tx_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_multiplexer_0001 cmd_mux_001 (
		.clk                 (rx_clk_module_clk_clk),                       //       clk.clk
		.reset               (rx_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_demultiplexer_0002 rsp_demux (
		.clk                (tx_clk_module_clk_clk),                       //       clk.clk
		.reset              (tx_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_demultiplexer_0002 rsp_demux_001 (
		.clk                (rx_clk_module_clk_clk),                       //       clk.clk
		.reset              (rx_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_multiplexer_0002 rsp_mux (
		.clk                 (csr_clk_module_clk_clk),                                     //       clk.clk
		.reset               (merlin_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
