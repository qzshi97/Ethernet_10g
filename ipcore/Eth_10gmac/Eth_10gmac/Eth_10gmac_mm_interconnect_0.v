// Eth_10gmac_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module Eth_10gmac_mm_interconnect_0 (
	...
	Eth_10gmac_mm_interconnect_0_router router (
	...
	Eth_10gmac_mm_interconnect_0_router_001 router_001 (
	...
	Eth_10gmac_mm_interconnect_0_router_001 router_002 (
	...
	Eth_10gmac_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (csr_clk_module_clk_clk),                                                           //        clk.clk
		.reset              (merlin_master_translator_reset_reset_bridge_in_reset_reset),                       //  clk_reset.reset
	...
	Eth_10gmac_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (tx_clk_module_clk_clk),                       //       clk.clk
		.reset               (tx_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Eth_10gmac_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (rx_clk_module_clk_clk),                       //       clk.clk
		.reset               (rx_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Eth_10gmac_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (tx_clk_module_clk_clk),                       //       clk.clk
		.reset              (tx_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Eth_10gmac_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (rx_clk_module_clk_clk),                       //       clk.clk
		.reset              (rx_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Eth_10gmac_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (csr_clk_module_clk_clk),                                     //       clk.clk
		.reset               (merlin_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
